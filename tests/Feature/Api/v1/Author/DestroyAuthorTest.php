...
class DestroyAuthorTest extends TestCase
{
    ...
    {
        $authorCreated = Author::factory()->create();
        $response = $this->deleteJson("/api/v1/author/$authorCreated->id");

        $response->assertStatus(401)
            ->assertJson(['message' => "Unauthenticated."]);
    }

    public function test_route_author_destroy_is_not_working_without_permissions()
    {
        $authorCreated = Author::factory()->create();
        Sanctum::actingAs(
            User::factory()->create(),
    ...
    public function test_route_author_destroy_is_not_working_with_false_id()
    {
        ...
        $response = $this->deleteJson("/api/v1/author/0");
    ...
    public function test_route_author_destroy_is_working()
    {
        ...
        $this->assertEmpty(Author::find($authorCreated->id));
    }
}
